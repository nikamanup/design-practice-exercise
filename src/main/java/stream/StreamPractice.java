...
public class StreamPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(oneToTen.stream().sorted((x2,x1)->Integer.compare(x1, x2)).collect(Collectors.toList()));
        ...
        System.out.println(oneToTen.stream().max((x1,x2)->Integer.compare(x1,x2)).get());
        System.out.println(oneToTen.stream().min((x1,x2)->Integer.compare(x1,x2)).get());
        ...
        .toArray();
        System.out.println("Merge"+Arrays.toString(mergedSortedArray));
      List<Integer> randomNumbers2 = List.of(12, 32, 2, 4, 777, 5, 32, 890, 422, 44, 99, 43);
      System.out.println(randomNumbers2.stream().sorted(Integer::compare).limit(3).collect(Collectors.toList()));
      System.out.println(randomNumbers2.stream().sorted((x,y)->Integer.compare(y, x)).limit(3).collect(Collectors.toList()));
